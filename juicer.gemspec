...
Gem::Specification.new do |s|
  ...
  s.files = ["History.txt", "Manifest.txt", "Rakefile", "Readme.rdoc", "bin/juicer", "lib/juicer.rb", "lib/juicer/binary.rb", "lib/juicer/cache_buster.rb", "lib/juicer/chainable.rb", "lib/juicer/cli.rb", "lib/juicer/command/install.rb", "lib/juicer/command/list.rb", "lib/juicer/command/merge.rb", "lib/juicer/command/util.rb", "lib/juicer/command/verify.rb", "lib/juicer/core.rb", "lib/juicer/install/base.rb", "lib/juicer/install/jslint_installer.rb", "lib/juicer/install/rhino_installer.rb", "lib/juicer/install/yui_compressor_installer.rb", "lib/juicer/jslint.rb", "lib/juicer/merger/base.rb", "lib/juicer/merger/css_dependency_resolver.rb", "lib/juicer/merger/dependency_resolver.rb", "lib/juicer/merger/javascript_dependency_resolver.rb", "lib/juicer/merger/javascript_merger.rb", "lib/juicer/merger/stylesheet_merger.rb", "lib/juicer/minifyer/yui_compressor.rb", "tasks/test/setup.rake", "test/bin/jslint.js", "test/bin/rhino1_7R1.zip", "test/bin/rhino1_7R2-RC1.zip", "test/bin/yuicompressor", "test/bin/yuicompressor-2.3.5.zip", "test/bin/yuicompressor-2.4.2.zip", "test/juicer/command/test_install.rb", "test/juicer/command/test_list.rb", "test/juicer/command/test_merge.rb", "test/juicer/command/test_util.rb", "test/juicer/command/test_verify.rb", "test/juicer/install/test_installer_base.rb", "test/juicer/install/test_jslint_installer.rb", "test/juicer/install/test_rhino_installer.rb", "test/juicer/install/test_yui_compressor_installer.rb", "test/juicer/merger/test_base.rb", "test/juicer/merger/test_css_dependency_resolver.rb", "test/juicer/merger/test_javascript_dependency_resolver.rb", "test/juicer/merger/test_javascript_merger.rb", "test/juicer/merger/test_stylesheet_merger.rb", "test/juicer/minifyer/test_yui_compressor.rb", "test/juicer/test_cache_buster.rb", "test/juicer/test_chainable.rb", "test/juicer/test_core.rb", "test/juicer/test_jslint.rb", "test/test_helper.rb", "test/test_juicer.rb"]
  s.has_rdoc = true
